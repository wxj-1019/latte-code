...
export function PromptInputHelpMenu(props) {
  ...
  let t23;
  if ($[25] !== dimColor) {
    t23 = <Box><Text dimColor={dimColor}>/ 查看命令</Text></Box>;
    $[25] = dimColor;
    $[26] = t23;
  } else {
    t23 = $[26];
  ...
  let t24;
  if ($[27] !== dimColor) {
    t24 = <Box><Text dimColor={dimColor}>@ 输入文件路径</Text></Box>;
    $[27] = dimColor;
    $[28] = t24;
  } else {
    t24 = $[28];
  ...
  let t26;
  if ($[31] !== dimColor) {
    t26 = <Box><Text dimColor={dimColor}>/btw 侧边提问</Text></Box>;
    $[31] = dimColor;
    $[32] = t26;
  } else {
    t26 = $[32];
  ...
  if ($[42] !== cycleModeShortcut || $[43] !== dimColor) {
    t30 = <Box><Text dimColor={dimColor}>{cycleModeShortcut}{" "}{false ? "循环切换模式" : "自动接受编辑"}</Text></Box>;
  ...
  if ($[45] !== dimColor || $[46] !== transcriptShortcut) {
    t31 = <Box><Text dimColor={dimColor}>{transcriptShortcut} 显示详细输出</Text></Box>;
    $[45] = dimColor;
  ...
  if ($[48] !== dimColor || $[49] !== todosShortcut) {
    t32 = <Box><Text dimColor={dimColor}>{todosShortcut} 切换任务显示</Text></Box>;
    $[48] = dimColor;
    $[49] = todosShortcut;
    $[50] = t32;
  } else {
  ...
  let t34;
  if ($[52] !== dimColor) {
    t34 = <Box><Text dimColor={dimColor}>{t33?.replace('for newlines', '换行').replace('new line', '新行')}</Text></Box>;
    $[52] = dimColor;
    $[53] = t34;
  } else {
    t34 = $[53];
