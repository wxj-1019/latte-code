...
export type CustomModelProvider = 'openai'

export type OpenAICompatibleMode = 'chat_completions' | 'responses'
...
export type GlobalConfig = {
   ...
   * as Bearer tokens against OpenAI's API â€?they are never sent to Anthropic servers.
   */
  codexOAuth?: {
    accessToken: string
    refreshToken: string
  ...
  // Saved custom models for OpenAI-compatible providers. Sensitive credentials
  // are stored separately in secure storage.
  customModels?: CustomModelConfig[]
  activeCustomModel?: string
