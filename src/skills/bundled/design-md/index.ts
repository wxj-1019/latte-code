...
• fetch - Retrieve complete or partial design systems
• search - Find design systems by category or keyword  
• analyze - Analyze colors, typography, accessibility
• generate - Generate CSS/Tailwind/styled-components code
• compare - Compare multiple design systems
• extract - Export to Figma tokens, CSS variables, etc
• advise - Design consultant: review, suggest, plan, apply
...
- /design-md compare apple,google-material,linear
...
可用能力：
• fetch - 获取完整或部分设计系统
• search - 按类别或关键词查找设计系统
• analyze - 分析颜色、排版、可访问性
• generate - 生成 CSS/Tailwind/styled-components 代码
• compare - 对比多个设计系统
• extract - 导出为 Figma tokens、CSS 变量等
• advise - 设计顾问：审查、建议、规划、应用
...
- /design-md compare apple,google-material,linear
- /design-md review stripe --file src/pages/Login.tsx
- /design-md suggest linear --context "创建仪表盘侧边栏"
- /design-md plan stripe --page-type dashboard --description "支付仪表盘"`
...
Available actions:
• get <brand> - Fetch a design system
• search <query> - Search design systems
• list - List all available brands
• analyze <brand> --type <colors|typography|accessibility|full>
• generate <brand> --output <css|tailwind|scss|styled-components>
• compare <brand1,brand2,...> - Compare design systems
• extract <brand> --type <colors|typography|components|full>
• review <brand> --file <path> - Review design compliance
• suggest <brand> --context <desc> - Get design suggestions
• plan <brand> --page-type <type> - Create design plan
...
Examples:
  ...
  /design-md review stripe --file src/pages/Login.tsx
  /design-md suggest linear --context "create a dashboard sidebar"
  /design-md plan linear --page-type dashboard --description "Project management dashboard"
