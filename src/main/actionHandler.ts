...
import { getAgentDefinitionsWithOverrides, isBuiltInAgent, isCustomAgent } from '../tools/AgentTool/loadAgentsDir.js';
import { setKairosActive, setSessionBypassPermissionsMode, getSessionId, getOriginalCwd, switchSession } from '../bootstrap/state.js';
import { maybeActivateProactive, maybeActivateBrief, extractTeammateOptions, logTenguInit } from './tailHelpers.js';
